...
public class ClientRentsDAOImpl implements ClientRentsDAO {
	...
	public void getRentsByCustomerId(String idCustomer) throws SQLException, DatabaseConnectionException {
		
		DBFactory dbFactory = new DBFactory();
		
		try{
			//Temporal variable, this task must be work with real parameters with beans 
